<script setup lang='ts'>
    ...
    function resize(e: MouseEvent) {
        let differenceX = startPointX - e.clientX;
        width.value += differenceX;
    }
...
<template>
    <div :style="`width: ${width}px; height: ${height}px;`" class="fixed overflow-hidden resize" xmlns="http://www.w3.org/1999/xhtml">
        <blockquote class="instagram-media" :data-instgrm-permalink="getUrl()" data-instgrm-version="14"
        ...
        <div class="absolute bg-black w-10 h-10 right-0 bottom-0" @mousedown="resize">
